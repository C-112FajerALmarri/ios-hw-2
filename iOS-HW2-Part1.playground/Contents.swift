...
var height = 1.52
var weight = 51.0
func total (weight:Double,height:Double) {
...
total(weight: weight , height: height)
//: # 1️⃣ السؤال الاول
/*:
...
*/
 var name = "fajer"
var age = "15"
func theConditions (name: String, age: String) {
    if age >= "18" {
        print("you can drive now")
    } else {
        print("you cant drive now")
    }
    
}
theConditions(name: name, age: age)
